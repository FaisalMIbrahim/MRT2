...
const AddRobot = () => {
  ...
  const [state_modified_by, settSate_modified_by] = useState("");
  ...
  const saveRobot = async (e) => {
    e.preventDefault();
    try {
      await axios
        .post("http://localhost:5000/robot", {
          id_robot: id_robot,
          video_uri: null,
          status: status,
          in_use: in_use,
                          ...
                          <div className="card-body">
                            ...
                            <div className="mb-3">
                              ...
                              <select
                                ...
                                onChange={(e) => settSate_modified_by(e.target.value)}
                              >
                                <option>Pilih Status :</option>
